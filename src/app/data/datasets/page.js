  ...
  return (
    <MainLayout>
      <div style={{ display: 'flex', gap: '20px', padding: '24px', minHeight: 'calc(100vh - 56px)'  } }>
        ...
        >
          {/* Filter Card */}
          <Card variant="borderless" style={{ borderRadius: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', border: '1px solid #f0f0f0' }} styles={{ body: { padding: '20px 24px'  } } }>
          ...
          {/* List Card */}
          <Card variant="borderless" style={{ borderRadius: '12px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', border: '1px solid #f0f0f0', flex: 1 }} styles={{ body: { padding: '24px'  } } }>
