...
export default function CreateDeviceInstancePage() {
  ...
  const handleSave = () => {
    form.validateFields().then(values => {
      ...
      router.push('/collection/device-list');
    }).catch(() => {
        ...
        <div style={{ marginBottom: 24 }}>
          <Space align="center" style={{ marginBottom: 8 }}>
            ...
            <Text type="secondary" style={{ fontSize: 13 }}>
              设备列表 / <Text style={{ color: '#1e293b', fontSize: 13 }}>新建设备</Text>
            </Text>
          </Space>
          <Title level={4} style={{ margin: '0 0 4px 0' }}>新建设备</Title>
          <Paragraph type="secondary" style={{ margin: 0, fontSize: 13 }}>
            填写以下信息创建新的设备实例，带 <Text type="danger">*</Text> 的为必填项。
          </Paragraph>
        </div>
      </motion.div>
