...
export default function CreateDevicePage() {
  ...
  const handleSave = () => {
    form.validateFields().then(values => {
      console.log('Create:', { ...values, parts });
        ...
        <div style={{ marginBottom: 24 }}>
          <Space align="center" style={{ marginBottom: 8 }}>
            ...
            <Text type="secondary" style={{ fontSize: 13 }}>
              设备类型管理 / <Text style={{ color: '#1e293b', fontSize: 13 }}>添加机器人设备</Text>
            </Text>
          </Space>
          <Title level={4} style={{ margin: '0 0 4px 0' }}>添加机器人设备</Title>
          <Paragraph type="secondary" style={{ margin: 0, fontSize: 13 }}>
            填写以下信息创建新的机器人设备类型，带 <Text type="danger">*</Text> 的为必填项。
          </Paragraph>
        </div>
      </motion.div>
          ...
          <Card 
            ...
            extra={
              <Select 
                ...
                onChange={(val) => {
                  ...
                  const partMap = {
                    ...
                    'depth_cam': { key: newKey, align: '头部', name: '深度相机_主', type: 'Body-DepthCamera(本体-深度相机)' },
                  };
              ...
              >
                ...
                <Select.Option value="depth_cam">深度相机_主</Select.Option>
              </Select>
            }
          >
            <Table
